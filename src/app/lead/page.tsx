...
export default function Page() {
  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center bg-prime-bg">
      <div className="p-20 max-w-[1140px] space-y-4 flex flex-col min-w-[800px] min-h-[650px] items-center rounded-2xl border bg-white hronit-shadow">
        <div className="flex gap-5 mb-11 flex-row">
          <form
            className="flex flex-1 flex-col gap-3 pb-10"
            onSubmit={() => ({})}
          >
            <div className="px-6 flex flex-col gap-4 justify-between w-[586px]">
              <h1 className="text-5xl font-semibold">Form For Lead</h1>
